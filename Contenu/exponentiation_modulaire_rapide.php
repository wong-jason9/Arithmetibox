...
?> 	
	...
	<form action="Arithmetibox.php?outil=expo_mod_rapide" method="post">
 	...
 	<?php
 		...
 		if(isset($_POST['entier']) and isset($_POST['puissance']) and isset($_POST['modulo']) ){
			
			if( trim($_POST['entier'])!='' and trim($_POST['puissance'])!='' and trim($_POST['modulo'])!='' 
			and preg_match("#^[0-9]+$#", $_POST['entier']) and preg_match("#^[0-9]+$#", $_POST['puissance']) 
