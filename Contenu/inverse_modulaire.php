...
<form action="Arithmetibox.php?outil=inv_mod" method='post'>
...
<?php
      if(isset($_POST['entier']) and isset($_POST['modulo']) ){
			if(trim($_POST['entier'])!='' and trim($_POST['modulo'])!='' and preg_match('#^[0-9]+$#', $_POST['entier']) 
